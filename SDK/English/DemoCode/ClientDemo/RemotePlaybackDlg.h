...
protected:
	...
	afx_msg void OnReleasedcaptureSliderRemote(NMHDR* pNMHDR, LRESULT* pResult);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
public:
	...
	H264_DVR_FILE_DATA *m_szSend ;
	H264_DVR_FILE_DATA *m_szSendup;
	H264_DVR_FILE_DATA *m_szSendDown;
	void ClearMapResult();
