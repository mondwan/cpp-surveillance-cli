...
void CLocalPlayback::OnButtonOpen() 
{
	...
	if(dlg.DoModal()==IDOK)
	{
		...
		if(!strcmp(m_FilePathName.Right(4),"h264"))
		{
			...
			{
				AfxMessageBox(_CS("PlayBack.PlayWrong"));
			}
		}
		else
		{
			AfxMessageBox(_CS("PlayBack.FormatError"));
		}
		//GetDlgItem(IDC_SLIDERFILE)->EnableWindow(TRUE); //HW
		//SetTimer(1,1000,NULL);
	}
