...
void CPTZDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_COMBO3, m_comSpeed);
}
...
BEGIN_MESSAGE_MAP(CPTZDlg, CDialog)
	//{{AFX_MSG_MAP(CPTZDlg)
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_CRUISEPLAY, &CPTZDlg::OnBnClickedCruiseplay)
	ON_BN_CLICKED(IDC_BUTTONLEFTUP, &CPTZDlg::OnBnClickedButtonleftup)
	ON_CBN_SELCHANGE(IDC_COMBO3, &CPTZDlg::OnCbnSelchangeCombo3)
END_MESSAGE_MAP()
...
void CPTZDlg::OnBnClickedCruiseplay()
{
	// TODO: 在此添加控件通知处理程序代码
}

void CPTZDlg::OnBnClickedButtonleftup()
{
	// TODO: 在此添加控件通知处理程序代码
}

void CPTZDlg::OnCbnSelchangeCombo3()
{
	// TODO: 在此添加控件通知处理程序代码
}
