...
protected:
	...
	afx_msg void OnReleasedcaptureSliderBackplay(NMHDR* pNMHDR, LRESULT* pResult);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
private:
	...
	void ClearResult();
	void OnDownloadByName(bool bDown = false);
...
public:
	void OnPlayByTime(char* sTime =NULL, bool bAgain=false);
	void OnPlayByName(char* sTime =NULL, bool bAgain=false);
	afx_msg void OnStop();
	DWORD m_preTime;
	DWORD m_prePos;
	int m_sliderPos;
	...
	CRecordPeriodDlg m_TimeReplayerView;
	...
	afx_msg void OnNMCustomdrawSliderBackplay(NMHDR *pNMHDR, LRESULT *pResult);
